package com.bridgelabz.jdbc1.addressbook;
...
public class BookList {
	...
	void showPersonsByCity(String placeName) throws IOException {
		...
		File dir = new File("D:\\BridgelabzClassWork\\Assignment-243\\addressbook\\src\\main\\java\\com\\bridgelabz\\jdbc1\\addressbook\\test");
	...
	int checkBook(String name) throws IOException {
		int result = 0;
		int track = 0;
		File file = new File("D:\\BridgelabzClassWork\\Assignment-243\\addressbook\\src\\main\\java\\com\\bridgelabz\\jdbc1\\addressbook\\test" + name + ".txt");
		if (!file.exists()) {
